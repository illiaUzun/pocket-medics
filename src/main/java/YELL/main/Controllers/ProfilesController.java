...
public class ProfilesController {
    ...
    public List<Medic> getFavourites(@RequestParam(name = "id", required = true) long id) {
        return profilesService.getUserById(id).get().getFavourites();
    }

    @RequestMapping(value = "/user/favourite", method = RequestMethod.GET)
    public boolean addFavourite(@RequestParam(name = "id_medic", required = true) long idMedic,
        ...
        return profilesService.getUserById(idUser).get().getFavourites().add(listService.getMedicById(idMedic).get());
    }
